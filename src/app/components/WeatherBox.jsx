...
const WeatherBox = () => {
	return (
		// Main box
		<div classNameName="group aspect-h-1 aspect-w-2 overflow-hidden rounded-lg sm:aspect-h-1 sm:aspect-w-1 sm:row-span-2 bg-transparent">
			<div
				aria-hidden="true"
				classNameName="bg-gradient-to-b from-transparent to-black opacity-50"
			/>
			{/* <!-- Weather GUI Componenet Start --> */}
			<div className="text-brand-black ">
				{/* Top Box */}
				<div className="mt-6 mb-6 w-full max-w-screen-sm p-10 rounded-xl ring-8 ring-white ring-opacity-40 bg-white/50">
					<div classNameName="flex items-end p-6 ">
						<div className="text-2xl  font-bold">
							<h3 classNameName="font-semibold text-white">
								<a href="#">
									<span classNameName="absolute inset-0" />
									Local Weather
								</a>
							</h3>
							<p aria-hidden="true" classNameName="mt-1 text-sm text-white">
								City, State
							</p>
						</div>
					</div>
				...
				{/* Middle Box */}
				<div className="w-full max-w-screen-sm b p-10 mt-10 rounded-xl ring-8 ring-white ring-opacity-40 bg-white/50">
					<div className="flex justify-between">
						<div className="flex flex-col">
							<span className="text-6xl  font-bold">29°C</span>
							<span className="font-semibold mt-1 text-white"></span>
						</div>
						{/* Sun Image */}
						<svg
							className="h-24 w-24 fill-current text-brand-orange"
					...
					<div className="flex justify-between mt-12 ">
						<div className="flex flex-col items-center">
							...
							<svg
								className="h-10 w-10 fill-current text-brand-orange mt-3"
								xmlns="http://www.w3.org/2000/svg"
								height="24"
								viewBox="0 0 24 24"
								width="24"
						...
						<div className="flex flex-col items-center ">
							...
							<svg
								className="h-10 w-10 fill-current  mt-3"
								xmlns="http://www.w3.org/2000/svg"
								height="24"
								viewBox="0 0 24 24"
								width="24"
						...
						<div className="flex flex-col items-center">
							...
							{/* Moon Image */}
							<svg
								className="h-10 w-10 fill-current text-brand-black mt-3"
								xmlns="http://www.w3.org/2000/svg"
				...
				<div className="flex flex-col space-y-6 w-full max-w-screen-sm  p-10 mt-10 rounded-xl ring-8 ring-white ring-opacity-40 bg-white/50">
					<div className="flex justify-between items-center">
						...
						<div className="flex items-center justify-end w-1/4 pr-10">
							...
							{/* raindrop */}
							<svg
								className="w-6 h-6 fill-current ml-1 text-brand-blue"
								viewBox="0 0 16 20"
								version="1.1"
								xmlns="http://www.w3.org/2000/svg"
							>
						...
						<svg
							className="h-8 w-8 fill-current w-1/4 text-brand-orange"
							xmlns="http://www.w3.org/2000/svg"
							height="24"
							viewBox="0 0 24 24"
							width="24"
